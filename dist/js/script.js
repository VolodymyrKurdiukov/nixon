...
if (isMobile.any()) {
	...
	let menuArrows = document.querySelectorAll('.menu-top-header__arrow');
...
//Бургер
const iconMenu = document.querySelector(".menu-top-header__icon");
if (iconMenu) {
	const menuBody = document.querySelector(".menu-top-header__body");
